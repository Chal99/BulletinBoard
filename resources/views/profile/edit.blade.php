...
<div class="card m-5">
    ...
    <div class="card-body">
        <form>
            ...
            <div class="form-group">
                <label for="type-selected">Type <span>*</span></label>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="editinput">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="exampleFormControlFile1">Old Profile</label>
                ...
                <input type="file" class="form-control-file" id="editinput">
            </div>
